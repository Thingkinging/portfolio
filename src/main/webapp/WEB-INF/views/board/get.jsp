...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">게시글 작성글</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-heading">작성글</div>
			<!-- /.panel-heading -->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label>글 내용</label> <input class="form-control" name='reply'
						value='New Reply!!!!'>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>작성시간</label> <input class="form-control"
